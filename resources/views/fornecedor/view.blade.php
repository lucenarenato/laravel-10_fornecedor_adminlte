...
@section('content')
    <div class="container-fluid">
                                ...
                                <div class="formulario_juridica row">
                                    <div class="mb-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cnpj" name="cnpj" class="form-control" name="cnpj" id="cnpj" value={{$fornecedores->cnpj_cpf}} readonly />
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <div class="form-group"><label class="form-label">Razão Social</label><input type="text" name="name" class="form-control" value="{{$fornecedores->razao_social}}" readonly /></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group"><label class="form-label">Nome Fantasia</label><input type="text" name="nome_fantasia" class="form-control not-value" value={{$fornecedores->nome_fantasia}} readonly /></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group"><label class="form-label">Indicador de Inscrição Estadual</label><input type="text" name="indicador_estadual" class="form-control" value={{$fornecedores->indicador_estadual}} readonly /></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group"><label class="form-label">Inscrição Estadual</label><input type="text" name="inscricao_estadual" class="form-control" value={{$fornecedores->inscricao_estadual}} {{$fornecedores->inscricao_estadual ? 'readonly':''}}></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group"><label class="form-label">Inscrição Municipal</label><input type="text" name="inscricao_municipal" class="form-control not-value" value={{$fornecedores->inscricao_municipal}} {{$fornecedores->inscricao_municipal ? 'readonly':''}}></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group"><label class="form-label">Recolhimento</label><input type="text" name="recolhimento" class="form-control" value={{$fornecedores->recolhimento}} readonly /></div>
                                    </div>
                                </div>
                            @else
                                <label class="radio-inline">
                                ...
                                <div class="formulario_fisica row">
                                    <div class="mb-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cpf" name="cpf" class="form-control" name="cpf" id="cpf" value={{$fornecedores->cnpj_cpf}} readonly />
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <div class="form-group"><label class="form-label">Nome</label><input type="text" name="name" class="form-control" value="{{$fornecedores->razao_social}}" readonly /></div>
                                    </div>
                                    <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href={{$fornecedores->id . "/editar"}} class="btn btn-sm btn-primary"><i class="fa fa-edit fa-fw"></i> Editar</a>
                </div>
            </div>
